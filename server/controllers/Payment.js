...
exports.verifySignature = async (req, res) => {
    ...
    const signature = req.headers("x-razropay-signature");
    ...
    if (signature === digest) {
        ...
        try {
            ...
            const emailResponse = await mailSender(enrolledStudent.email, "Congratulation from CodeHelp", "Congratulation you are onboarded into new CodeHelp Course");
